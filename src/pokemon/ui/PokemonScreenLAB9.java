...
public class PokemonScreenLAB9 extends Application {
	...
	private static final String pikachu1=new File("icons/pikachu.gif").toURI().toString();
	...
	public void start(Stage stage) throws Exception {
		...
		int x=pr.nextInt(600);
		int y=pr.nextInt(400);
		currentPosx = x-x%40; // this should be a random position
		currentPosy = y-y%40; // this should be a random position

		pikachuImage=new Image(pikachu1);
